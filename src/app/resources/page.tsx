    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl relative">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6">
          ...
          {/* Search bar */}
          <div className="bg-white p-4 rounded-3xl border border-slate-200 shadow-[0_4px_20px_rgb(0,0,0,0.02)]">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-3.5 text-sm border border-slate-200 rounded-2xl bg-slate-50/50 focus:bg-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all outline-none"
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredResources.map((res, index) => (
                <motion.div
                  ...
                  className="bg-white border border-slate-200 rounded-3xl p-6 shadow-[0_4px_16px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-0.5 transition-all flex flex-col h-full relative overflow-hidden group"
                >
